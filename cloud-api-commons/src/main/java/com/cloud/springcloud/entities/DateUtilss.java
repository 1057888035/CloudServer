...
public class DateUtilss {
        ...
        public static String getCurrentHour() {
            ...
            if (hour < 10) {
                return DateUtilss.getCurrentTime() + " 0" + hour;
            }
            return DateUtilss.getDateByString() + " " + hour;
        }
        ...
        public static String getCurrentHourBefore() {
            ...
            if (hour > 0) {
                ...
                if (hour < 10) {
                    return DateUtilss.getDateByString() + " 0" + hour;
                }
                return DateUtilss.getDateByString() + " " + hour;
            }
            //获取当前日期前一天
            return DateUtilss.getBeforeDay() + " " + 23;
        }
