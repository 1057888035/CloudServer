...
public class FchannelController {
    ...
    FchannelService fchannelService;
      ...
      @GetMapping(value = "/findbycode",name = "根据fcode查配置")
    public CommonResult<List<Fchannel>> findByCode(String fcode){
    ...
    @GetMapping(value = "/update",name = "更新fcode配置")
    public CommonResult<List<Fchannel>> update(Collection<Fchannel> entityList){
